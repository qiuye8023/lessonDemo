...
{
    return [self initWithScrollView:scrollView beginRefreshingBlock:nil];
}

-(id)initWithScrollView:(UIScrollView *)scrollView beginRefreshingBlock:(BeginRefreshingBlock)block{
    if (self = [super init]) {
        self.scrollView = scrollView;
        self.beginRefreshingBlock=block;
    }
    return self;
}
